...
import com.db.assignment.trade.controller.TradeController;
...
class DbassignmentApplicationTests {
	...
	void testTradeValidateAndStoreWhenMaturityDatePast() {
		...
		} catch (NotValidTradeException ie) {
			Assertions.assertEquals("Not valid Trade: Trade Id is not found", ie.getMessage());
		}
	}
	...
	void testTradeValidateAndStoreWhenOldVersion() {
		...
		} catch (NotValidTradeException e) {
